! function(e, t) {
    ...
    return function(e) {
        ...
        var a = o(34),
            s = r(a),
            l = [s.default, function() {
                return {
                    components: {
                        StandaloneLayout: i.default
                    }
                }
            }];
        e.exports = l
                ...
                return a(t, e), s(t, [{
                    ...
                    value: function() {
                        var e = this.props,
                            ...
                            y = r("schemes"),
                            k = r("Topbar", !0),
                            v = r("onlineValidatorBadge", !0),
                            E = t.loadingStatus();
                        return p.default.createElement(m, {
                            className: "swagger-ui"
                        }, k ? p.default.createElement(k, null) : null, "loading" === E && p.default.createElement("div", {
                            className: "info"
                        }, p.default.createElement("h4", {
                            className: "title"
                        }, "Loading...")), "failed" === E && p.default.createElement("div", {
                            className: "info"
                        }, p.default.createElement("h4", {
                            className: "title"
                        }, "Failed to load spec.")), "failedConfig" === E && p.default.createElement("div", {
                            className: "info",
                            style: {
                                maxWidth: "880px",
                                marginLeft: "auto",
                            ...
                            className: "title"
                        }, "Failed to load config.")), "success" === E && p.default.createElement("div", null, p.default.createElement(h, null), p.default.createElement(x, {
                            className: "information-container"
                        }, p.default.createElement(w, {
                            mobile: 12
                        }, n.count() ? p.default.createElement(f, {
                            info: n,
                            url: i,
                            host: s,
                            basePath: a,
                            externalDocs: u,
                            getComponent: r
                        }) : null)), c && c.size || l ? p.default.createElement("div", {
                            className: "scheme-container"
                        }, p.default.createElement(w, {
                            className: "schemes wrapper",
                            mobile: 12
                        }, c && c.size ? p.default.createElement(y, {
                            schemes: c,
                            specActions: o
                        }) : null, l ? p.default.createElement(b, null) : null)) : null, p.default.createElement(x, null, p.default.createElement(w, {
                            mobile: 12,
                            desktop: 12
                        }, p.default.createElement(d, null))), p.default.createElement(x, null, p.default.createElement(w, {
                            mobile: 12,
                            desktop: 12
                        }, p.default.createElement(g, null)))), p.default.createElement(x, null, p.default.createElement(w, null, p.default.createElement(v, null))))
                    }
                }]), t
            }(p.default.Component);
        u.propTypes = {
        ...
        var k = {
            forEach: a,
            map: u,
            mapIntoWithKeyPrefixInternal: p,
            count: f,
            toArray: d
        };
        e.exports = k
        ...
        function n(e, t, o, i) {
            ...
            if (Array.isArray(e))
                ...
                if (w) {
                    ...
                    var E = "",
                        A = String(e);
                    a("31", "[object Object]" === A ? "object with keys {" + Object.keys(e).join(", ") + "}" : A, E)
                }
            }
            return b
        }
        ...
        function i(e) {
            function t(t, o, r, i, a, s, l) {
                i = i || P, s = s || r;
                if (null == o[r]) {
                    var p = v[a];
                    return t ? new n(null === o[r] ? "The " + p + " `" + s + "` is marked as required " + ("in `" + i + "`, but its value is `null`.") : "The " + p + " `" + s + "` is marked as required in " + ("`" + i + "`, but its value is `undefined`.")) : null
                }
                return e(o, r, i, a, s)
            }
            var o = t.bind(null, !1);
        ...
        function f(e) {
            function t(t, o, r, i, a) {
                ...
                if ("object" !== l) {
                    var p = v[i];
                    return new n("Invalid " + p + " `" + a + "` of type " + ("`" + l + "` supplied to `" + r + "`, expected an object."))
                }
                for (var u in s)
        ...
        function d(e) {
            function t(t, o, r, i, a) {
                for (var s = 0; s < e.length; s++) {
                    var l = e[s];
                    if (null == l(t, o, r, i, a, E)) return null
                }
                var p = v[i];
                return new n("Invalid " + p + " `" + a + "` supplied to " + ("`" + r + "`."))
            }
            return Array.isArray(e) ? i(t) : A.thatReturnsNull
        }
        ...
        function g() {
            function e(e, t, o, r, i) {
                if (!m(e[t])) {
                    var a = v[r];
                    return new n("Invalid " + a + " `" + i + "` supplied to " + ("`" + o + "`, expected a ReactNode."))
                }
                return null
            }
            return i(e)
        ...
        function b(e) {
            function t(t, o, r, i, a) {
                ...
                if ("object" !== l) {
                    var p = v[i];
                    return new n("Invalid " + p + " `" + a + "` of type `" + l + "` " + ("supplied to `" + r + "`, expected `object`."))
                }
                for (var u in e) {
                    var c = e[u];
                    if (c) {
                        var f = c(s, u, r, i, a + "." + u, E);
                        if (f) return f
                    }
                }
                return null
        ...
        function n(e) {
            for (var t = [], o = {}, r = 0; r < e.length; r++) {
                ...
                o[i] ? o[i].parts.push(p) : t.push(o[i] = {
                    id: i,
                    parts: [p]
                })
            }
        ...
        var s = function() {
            ...
            f = function(e) {
                function t(e, o) {
                    ...
                    }, r.downloadUrl = function() {
                        r.props.specActions.updateUrl(r.state.url), r.props.specActions.download(r.state.url)
                    }, r.state = {
                ...
                return a(t, e), s(t, [{
                    ...
                    value: function() {
                        var e = this.props,
                            ...
                            s = {};
                        return a && (s.color = "red"), i && (s.color = "#aaa"), p.default.createElement("div", {
                            className: "topbar"
                            ...
                            src: c.default,
                            alt: "Swagger UX"
                        }), p.default.createElement("span", null, "swagger")), p.default.createElement("div", {
