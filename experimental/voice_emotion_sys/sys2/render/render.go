...
func recordData(task string) (string, string) {
	...
	//make the unit as second
	eb.AnalysisStart = eb.AnalysisStart / 1000
	eb.AnalysisEnd = eb.AnalysisEnd / 1000
...
func main() {
	...
	*/
	...
	parseEnv()
	//fakeEnv()
	handlers.InitDatabaseCon(envs["DB_HOST"], envs["DB_PORT"], envs["DB_USER"], envs["DB_PWD"])
	//handlers.QueryBlob()
	//recordData(task)
