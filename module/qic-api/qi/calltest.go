...
var exampleCallContent = []byte(`call_id,status,"call_uuid","file_name","file_path","description",duration,upload_time,call_time,"staff_id","staff_name","extension","department","customer_id","customer_name","customer_phone","enterprise","uploader",left_silence_time,right_silence_time,left_speed,right_speed,type,left_channel,right_channel,"apply_group_list"
1,0,"633f349535eb4d748eba577104776185","test1","/tmp/test1.mp3","testing case 1",120,1546598521,1546598521,"1","Taylor","2222","Backend","2","Dean","123456789","csbot","bot",NULL,NULL,NULL,NULL,0,0,1,NULL
2,2,"ec94dfd6e3974671b8a3533c752e51a6","test2","/tmp/test2.mp3","testing case 2",45,1546598657,1546598657,"1","Taylor","2222","Backend","3","Ken","123456789","csbot","bot",12.31,1.3,30,30,0,1,0,NULL
`)

var exampleTaskContent = []byte(``)
