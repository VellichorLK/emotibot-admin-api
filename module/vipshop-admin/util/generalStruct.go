...
func NewEntryPoint(method string, path string, callback func(ctx context.Context)) EntryPoint {
...
func NewEntryPointWithVer(method string, path string, callback func(ctx context.Context), version int) EntryPoint {
	entrypoint := EntryPoint{}
	entrypoint.AllowMethod = method
	entrypoint.EntryPath = path
	entrypoint.Callback = callback
