...
var TableProps = clusterTable{
	feedback:      feedbackProps{name: "user_feedback", id: "id", question: "question", stdQuestion: "std_question", createdTime: "created_time", updatedTime: "updated_time", appid: "appid"},
	...
	report:        reportProps{name: "unresolved_report", id: "id", createdTime: "created_time", startTime: "start_time", endTime: "end_time", status: "status", appid: "appid"},
}
